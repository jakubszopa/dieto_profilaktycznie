...
export const metadata: Metadata = {
  title: "Dieto-Profilaktycznie",
  description: "Hej, jestem Elizka, ze mną przestaniesz być grubasem!",
}
    ...
    <html lang="en">
      <body className={playfairDisplay.className}>
        <header className="flex justify-center p-4">
          <nav className="container flex flex-row items-center text-xl gap-16">
            <div className="navbar bg-base-100 rounded-box lg:px-12">
              ...
              <div className="navbar-end">
                <a className="btn">Skontaktuj się</a>
              </div>
            </div>
          </nav>
        </header>
